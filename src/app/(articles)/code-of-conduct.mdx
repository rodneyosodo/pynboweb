...
If you believe that someone is violating the code of conduct, or have any other concerns, ease contact a member of the event staff immediately. They can be reached by emailing [info@pycon.ke](mailto:info@pycon.ke)

In case of a conflict of interest, you can contact us at [info@pycon.ke](mailto:info@pycon.ke)
